...
class ProductListController extends GetxController {
  ...
  void init({bool isFromSwipRefresh = false}) {
    if (Get.arguments is ProductStatusModel) {
      argumentsList(Get.arguments as ProductStatusModel);
    }

    getProductsList(categoryId: argumentsList.value.productCategoryID, bestDiscount: argumentsList.value.isDeal, isFeatured: argumentsList.value.isFeatured, bestSeller: argumentsList.value.isBestSeller, isFromSwipRefresh: isFromSwipRefresh);
  }
